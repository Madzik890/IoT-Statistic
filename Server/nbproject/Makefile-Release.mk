...
${OBJECTDIR}/src/DataBase/DataBase.o: src/DataBase/DataBase.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DataBase/DataBase.o src/DataBase/DataBase.cpp

${OBJECTDIR}/src/Device/Device.o: src/Device/Device.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Device
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Device/Device.o src/Device/Device.cpp

${OBJECTDIR}/src/ServerCallback.o: src/ServerCallback.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ServerCallback.o src/ServerCallback.cpp

${OBJECTDIR}/src/SeverSSL.o: src/SeverSSL.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SeverSSL.o src/SeverSSL.cpp

${OBJECTDIR}/src/pugixml.o: src/pugixml.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pugixml.o src/pugixml.cpp
