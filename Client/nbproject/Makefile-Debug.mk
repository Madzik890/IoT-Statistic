...
${OBJECTDIR}/src/ClientSSL.o: src/ClientSSL.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ClientSSL.o src/ClientSSL.cpp

${OBJECTDIR}/src/CoreTemp.o: src/CoreTemp.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CoreTemp.o src/CoreTemp.cpp

${OBJECTDIR}/src/DiskSpace.o: src/DiskSpace.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DiskSpace.o src/DiskSpace.cpp

${OBJECTDIR}/src/MemorySpace.o: src/MemorySpace.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MemorySpace.o src/MemorySpace.cpp
